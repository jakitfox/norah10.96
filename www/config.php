<?php
	...
	$config['sqlPassword'] = 'Esiok1212';

	// The database name to connect to. (This is usually same as username).
	$config['sqlDatabase'] = 'norah';
	...
	*/
	...
	$config['house'] = array(
			'house_file' => '/home/norah/data/world/Mapa1-house.xml',
	...
	$config['client'] = 1096; // 954 = tibia 9.54
	...
	$config['client_download'] = '/download/tibia1096.exe';
