...
function onThink(interval, lastExecution)
	local spectators, spectator = Game.getSpectators(Position(774,906,7), false, true, 0, 15, 0, 15)
	for i = 1, #spectators do
		...
		spectator:say(sounds[math.random(#sounds)], TALKTYPE_MONSTER_YELL, false, 0, Position(774,906,7))
	end
	return true
end