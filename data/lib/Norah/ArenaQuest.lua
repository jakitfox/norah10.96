...
SvargrondArena = {
	...
	kickTime = 600,
	kickPosition = Position(812,375,7),
	rewardPosition = Position(812, 361, 6),
...
local firstPit = {
	fromPos = {x = 795, y = 375, z = 7},
	toPos = {x = 804, y = 384, z = 7},
	center = {x = 800, y = 379, z = 7},
	pillar = {x = 794, y = 379, z = 7},
	tp = {x = 794, y = 379, z = 7},
	summon = {x = 800, y = 381, z = 7}
}
