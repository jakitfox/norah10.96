local config = {
	...
	[18215] = { -- gnomish supply package
		...
		chances = {
			{from = 1, to = 2},
			{from = 3, to = 2167, itemId = 23529, count = 2},
			{from = 2168, to = 4243, itemId = 23554},
			{from = 4244, to = 6196, itemId = 23549},
			{from = 6197, to = 7149, itemId = 23551},
			{from = 7150, to = 8123, itemId = 23550},
			{from = 8124, to = 8823, itemId = 23666},
			{from = 8824, to = 9200, itemId = 23514, count = 2},
			{from = 9201, to = 9500, itemId = 23515, count = 2},
			{from = 9501, to = 9800, itemId = 23517, count = 2},
			{from = 9991, to = 10001, itemId = 23557}
		},
		effect = CONST_ME_HITBYPOISON
	}
}
