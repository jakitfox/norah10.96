...
--9.80--
shopModule:addSellableItem({'life preserver', 'life preserver'},             20093, 300,     'life preserver')
shopModule:addSellableItem({'pair of iron fists', 'pair of iron fists'},     20108, 4000,     'pair of iron fists')
shopModule:addSellableItem({'spiky club', 'spiky club'},            		 20139, 300,     'spiky club')
shopModule:addSellableItem({'swampling club', 'swampling club'},             20104, 40,     'swampling club')
--9.60--
shopModule:addSellableItem({'crystal crossbow', 'crystal crossbow'},         18453, 35000,     'crystal crossbow')
shopModule:addSellableItem({'mycological bow', 'mycological bow'},           18454, 35000,     'mycological bow')
--10.50--
shopModule:addSellableItem({'moohtant cudgel', 'moohtant cudgel'},           23544, 14000,     'moohtant cudgel')
shopModule:addSellableItem({'mino lance', 'mino lance'},            	 	 23545, 7000,     'mino lance')
shopModule:addSellableItem({'metal bat', 'metal bat'},            			 23542, 9000,     'metal bat')
shopModule:addSellableItem({'glooth whip', 'glooth whip'},            		 23543, 2500,     'glooth whip')
shopModule:addSellableItem({'glooth club', 'glooth club'},            		 23549, 1500,     'glooth club')
shopModule:addSellableItem({'glooth blade', 'glooth blade'},            	 23550, 1500,     'glooth blade')
shopModule:addSellableItem({'glooth axe', 'glooth axe'},            		 23551, 1500,     'glooth axe')
shopModule:addSellableItem({'execowtioner axe', 'execowtioner axe'},         23547, 12000,     'execowtioner axe')
shopModule:addSellableItem({'cowtana ', 'cowtana '},            			 23548, 2500,     'cowtana ')
shopModule:addSellableItem({'ratana', 'ratana'},            				 20092, 500,     'ratana')
shopModule:addSellableItem({'ratana', 'ratana'},            				 20092, 500,     'ratana')
shopModule:addSellableItem({'ratana', 'ratana'},            				 20092, 500,     'ratana')
shopModule:addSellableItem({'ratana', 'ratana'},            				 20092, 500,     'ratana')
shopModule:addSellableItem({'ratana', 'ratana'},            				 20092, 500,     'ratana')
