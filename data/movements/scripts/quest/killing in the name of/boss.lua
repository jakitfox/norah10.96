...
local bosses = {
	...
	[3218] = {bossName = 'bloodweb', storage = 3509, playerPosition = Position(592, 424, 11), bossPosition = Position(600, 427, 11), centerPosition = Position(598, 425, 11), rangeX = 10, rangeY = 8, flamePosition = Position(645, 512, 10)},
