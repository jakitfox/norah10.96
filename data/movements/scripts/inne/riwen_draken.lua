...
if item.uid == 3171 then
	if player:getStorageValue(Storage.Others.RiwenPass) == 1 then
...
elseif item.actionid == 3175 and player:getStorageValue(Storage.Others.RiwenPass) == -1 then
	player:setStorageValue(Storage.Others.RiwenPass, 1)
end	
return true
end